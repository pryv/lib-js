...
module.exports = JSON.parse("{\"name\":\"pryv\",\"version\":\"2.0.3\",\"homepage\":\"https://github.com/pryv/lib-js\",\"description\":\"Pryv Javascript Library\",\"keywords\":[\"Pryv\"],\"repository\":{\"type\":\"git\",\"url\":\"git://github.com/pryv/lib-js\"},\"bugs\":{\"url\":\"https://github.com/pryv/lib-js/issues\"},\"author\":{\"name\":\"Pryv S.A.\"},\"main\":\"src/index.js\",\"license\":\"BSD-3-Clause\",\"scripts\":{\"setup\":\"./scripts/setup-environment-dev.sh\",\"build\":\"webpack --config webpack.config.js\",\"doc\":\"node node_modules/jsdoc/jsdoc.js -c .jsdoc-conf.json\",\"test\":\"mocha --reporter spec  test/**/*.test.js\",\"test-debug\":\"mocha --inpect-brk=40000 --reporter spec  test/**/*.test.js \",\"test:browser\":\"npm run build; \",\"cover\":\"nyc npm run test && npm run cover:report\",\"cover:report\":\"nyc report --reporter=lcov --reporter=html\",\"webserver\":\"node node_modules/rec-la/webserver/main.js ./dist 9443\",\"gh-pages\":\"./scripts/upload.sh\",\"clear\":\"rm -r dist/ && npm run setup\"},\"contributors\":[{\"name\":\"Pierre-Mikael Legris\",\"email\":\"perki@pryv.com\"}],\"dependencies\":{\"superagent\":\"^5.2.2\"},\"devDependencies\":{\"@babel/cli\":\"^7.10.1\",\"@babel/core\":\"^7.10.2\",\"@babel/node\":\"^7.10.1\",\"@babel/preset-env\":\"^7.10.2\",\"@babel/register\":\"^7.10.1\",\"babel-core\":\"^6.26.3\",\"babel-loader\":\"^8.1.0\",\"babel-polyfill\":\"^6.26.0\",\"babel-preset-es2015\":\"^6.24.1\",\"babel-preset-stage-0\":\"^6.24.1\",\"chai\":\"^4.2.0\",\"chai-as-promised\":\"^7.1.1\",\"copy-webpack-plugin\":\"^5.1.1\",\"css-loader\":\"^3.6.0\",\"cuid\":\"^2.1.8\",\"jsdoc\":\"^3.6.4\",\"mocha\":\"^6.2.3\",\"node-fetch\":\"^2.6.0\",\"nyc\":\"^14.1.1\",\"rec-la\":\"^0.1.13\",\"style-loader\":\"^1.2.1\",\"universal-url\":\"^2.0.0\",\"webpack\":\"^4.43.0\",\"webpack-cli\":\"^3.3.11\",\"webpack-dev-server\":\"^3.11.0\",\"zombie\":\"^6.1.4\"}}");
...
function _setupAuth() {
  _setupAuth = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(settings, serviceInfoUrl, serviceCustomizations) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
