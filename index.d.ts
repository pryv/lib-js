declare module 'pryv' {
  ...
  type EventQueryParamsStreamQuery = Omit<EventQueryParams, "streams"> & {
    streams: Array<string | StreamsQuery>
  };
  ...
  export type ApiCallMethods = {
    ...
    "accesses.create": {
      params: Partial<Omit<Access, "id" | "lastUsed" | "expires" | "deleted" | EditMetadata>>,
      res: {
        access: Access,
      }
    },
  ...
  export type ApiCallResult = Array<Error | ApiCallMethods[keyof ApiCallMethods]['res']>;
  export type ApiCallResultHandler = (result: ApiCallResult) => Promise<any>;
  ...
  export type EventFileCreationParams = {
    type: string;
    streamId: Identifier;
  };
  ...
  export type ApiCall<K extends keyof ApiCallMethods = keyof ApiCallMethods> =
    K extends keyof ApiCallMethods
      ? {
        ...
        handleResult?: ApiCallResultHandler;
      } : never;
  ...
  export interface Connection { 
    ...
    api(apiCalls: ApiCall[], res?: ApiCallProgressHandler[]): Promise<ApiCallResult>;
    getEventsStreamed(queryParams: Partial<EventQueryParamsStreamQuery>, forEachEvent: StreamedEventsHandler): Promise<StreamedEventsResult>;
    createEventWithFile(params: EventFileCreationParams, filePath: string | Buffer): Promise<void>;
    createEventWithFormData(params: EventFileCreationParams, formData: FormData): Promise<any>;
    addPointsToHFEvent(id: Identifier, fields: string[],values: Array<string | number>): Promise<void>;
    accessInfo(): Promise<AccessInfo>;

    post(path: string, data: Object | any[], queryParams: Object): Promise<Object | Object[]>;
  ...
  export interface Service {
    new(serviceInfoUrl: string, serviceCustomizations?: serviceCustomizations): Service;
    ...
    login(username: string, password: string, appId: string, originHeader?: string): Promise<Connection>;
  }
  ...
  type SetupAuth = (settings: AuthSettings, serviceInfoUrl: string, serviceCustomizations?: serviceCustomizations, humanInteraction?: any) => Promise<Service>;
  ...
  export interface AuthController {
    new(authSettings: AuthSettings, service: Service, loginButton: CustomLoginButton): AuthController;
    init(): Promise<void>;
    stopAuthRequest(msg: string): void;
    handleClick(): Promise<void>;
    getReturnURL(returnURL: string, windowLocationForTest: string, navigatorForTests: string): string | boolean;
